...
public class AppVariable {
	...
	public static String IP ="192.168.0.202";//Server IP
	public static int type ;// list type 0 = fresh, 1 =Skip
	public static int docid; 
	public static int calltoken; // call token for Skiplist
	public static String username;
	public static String password;
    public static String roomid;
	public static String callButtonStat = "Call";  
	public static String SkipListButtonStat ="Skip List";
	public static String listtype = "Fresh List"; 
	public static CustomDialog dialog;
	public static IpConfigDialog dialog1;
