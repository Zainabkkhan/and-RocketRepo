			 ...
			 public String login()
			    { Log.i("i am","in login");
			      ...
			      int status=AppVariable.getType();
			        ...
			        try {
			    		url = new URL("http://"+AppVariable.IP+":8080/dqms/ServiceDataAndroid?d="+AppVariable.getDocid()+"&t="+AppVariable.getType());
			    	Log.i("LNJP","http://"+AppVariable.IP+":8080/dqms/ServiceDataAndroid?d="+AppVariable.getDocid()+"&t="+AppVariable.getType());
