...
public class MainActivity extends Activity implements OnClickListener { 
    ...
    public void onCreate(Bundle savedInstanceState) {
       ...
       if(data.getString("data", null)!=null)
       {
        ...
        Button login = (Button) findViewById(R.id.button1);//login button
        Button signout = (Button)findViewById(R.id.button2);// signout button
        Button Ipconfig = (Button)findViewById(R.id.ipconfig);//ipconfig 
	...
	public void onClick(View v) {
	    ...
	    { 
			...
			String url="http://"+AppVariable.IP+":8080/dqms/LoginApiAndroid?u="+user.trim()+"&p="+pass.trim();
			url.replaceAll("//s+", "%20");
		...
		{ 
			...
			String url = "http://"+AppVariable.IP+":8080/dqms/LoginApiAndroid?u="+user.trim()+"&p="+pass.trim()+"&l=1";
